...
void TileAnimationParams::serialize(std::ostream &os, uint8_t tiledef_version) const
{
	writeU8(os, type);
...
void TileAnimationParams::deSerialize(std::istream &is, uint8_t tiledef_version)
{
